    ...
    <div class="invoice-details flex flex-column">
      ...
      <div class="bottom flex flex-column">
        ...
        <div class="total flex">
          <p>Amount Due</p>
          <p>₹{{ new Intl.NumberFormat('en-IN', { minimumFractionDigits: 2, maximumFractionDigits: 2 }).format(currentInvoice.invoiceTotal || 0) }}</p>
        </div>
      </div>
    </div>
  </div>
...
const getCurrentInvoice = () => {
  store.SET_CURRENT_INVOICE(id); // Ensure the store updates with the correct invoice
